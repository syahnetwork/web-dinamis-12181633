...
$statementt = $db_con->prepare("select * from dokter where dokter_id > :dokter_id");
$statementt->execute(array(':dokter_id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from dokter ORDER BY dokter_id ASC LIMIT $start_from, $limit");
$statement->execute();
