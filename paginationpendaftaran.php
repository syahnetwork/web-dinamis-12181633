...
$statementt = $db_con->prepare("select * from pendaftaran where pendaftaran_id > :pendaftaran_id");
$statementt->execute(array(':pendaftaran_id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from pendaftaran ORDER BY pendaftaran_id ASC LIMIT $start_from, $limit");
$statement->execute();
