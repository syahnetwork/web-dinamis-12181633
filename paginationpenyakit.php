...
$statementt = $db_con->prepare("select * from penyakit where penyakit_id > :penyakit_id");
$statementt->execute(array(':penyakit_id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from penyakit ORDER BY penyakit_id ASC LIMIT $start_from, $limit");
$statement->execute();
