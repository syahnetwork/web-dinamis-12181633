        ...
        <div class="row">
            <div class="widget ">
                <div id="formcontrols" class="tab-pane active">
                    ...
                    <form class="form-horizontal" id="add-pasien-form" method="post">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" placeholder="Nama" name="nama" required id="nama"
                                           class="span6">
                                    <p class="help-block">Silahkan masukkan identitas Pasien</p>
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="umur" placeholder="Umur" id="umur" class="span6">
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                            ...
                            <div class="form-actions">
                                <button class="btn btn-primary" type="button" id="addpasien">Save</button>
