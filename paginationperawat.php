...
$statementt = $db_con->prepare("select * from perawat where perawat_id > :perawat_id");
$statementt->execute(array(':perawat_id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from perawat ORDER BY perawat_id ASC LIMIT $start_from, $limit");
$statement->execute();
