...
$statementt = $db_con->prepare("select * from pembayaran where pembayaran_id > :pembayaran_id");
$statementt->execute(array(':pembayaran_id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from pembayaran ORDER BY pembayaran_id ASC LIMIT $start_from, $limit");
$statement->execute();
